"""
Django settings for ravinderyadav_2 project.
...
ROOT_URLCONF = 'ravinderyadav_2.urls'
...
WSGI_APPLICATION = 'ravinderyadav_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ravinderyadav_2 API",
    "DESCRIPTION": "API documentation for ravinderyadav_2 App",
    "VERSION": "v1",
}
